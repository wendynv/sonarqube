...
export default class WorkspaceNavRule extends React.PureComponent<Props> {
  ...
  render() {
    ...
    return (
      <li className="workspace-nav-item" key={`component-${rule.key}`}>
        <i className="icon-workspace-doc" />
        {/* TODO limit string */}
        {rule.name || '—'}
        <Button
